...
The task for writing script on Getting and Cleaining Data Programming 
Assingnment was as followes:
...
=============================================================================
The script in the uses data from: https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip
